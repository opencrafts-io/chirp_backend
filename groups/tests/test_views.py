...
class GroupListCreateViewTest(TestCase):
    ...
    def test_group_create_success(self):
        ...
        # Set up authentication by adding Authorization header
    ...
    def test_group_join_success(self):
        ...
        # Set up authentication for the joining user
        from chirp.jwt_utils import generate_test_token
        token = generate_test_token('new_user')
        self.client.defaults['HTTP_AUTHORIZATION'] = f'Bearer {token}'

        join_data = {}  # No need to pass user_id, it comes from JWT
...
# GroupAddMemberViewTest - This view doesn't exist in current implementation
...
# GroupInviteViewTest - This view doesn't exist in current implementation
...
#
#
# GroupAcceptInviteViewTest - This view doesn't exist in current implementation
...
#     def test_accept_invite_valid(self):
    ...
    # These tests are for views that don't exist in current implementation
...
# GroupPostListCreateViewTest - This view doesn't exist in current implementation
